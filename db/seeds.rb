...
50.times do
  Character.create(campaign_id: rand(Campaign.first.id..Campaign.last.id), alignment: ["Lawful Good", "Neutral Good", "Chaotic Good", "Lawful Neutral", "Neutral Neutral", "Chaotic Neutral", "Lawful Evil", "Neutral Evil", "Chaotic Evil"].sample, char_name: Faker::Games:WorldOfWarcraft.hero, class: ["Bard", "Barbarian", "Cleric", "Druid", "Fighter", "Monk", "Paladin", "Ranger", "Rouge", "Sorcerer", "Warlock", "Wizard"].sample, race: ["Gnome", "Halfling", "Dwarf", "Elf", "Half-Elf", "Teifling", "Human", "Dragonborn", "Half-Orc"].sample, weapon: Faker::Games::Zelda.item, level: rand(1..10))
end
